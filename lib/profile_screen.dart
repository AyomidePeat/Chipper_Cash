                    ...
                    child: RichText(
                      text: const TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text:
                                "Buy discounted airtime with your Chipper balance  \t",
                            style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.normal,
                              fontFamily: 'Montserrat',
                    ...
                    child: RichText(
                      text: const TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text:
                                "Pay your bills with your Chipper balance  \t",
                            style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.normal,
                              fontSize: 14,
                    ...
                    child: RichText(
                      text: const TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text:
                                "Connect Merchants to your account for seamless purchases",
                            style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.normal,
                              fontSize: 14,
                    ...
                    child: RichText(
                      text: const TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text:
                                "Sign into your account using multiple phone numbers and emails",
                            style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.normal,
                              fontSize: 14,
